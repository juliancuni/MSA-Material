...
/**
 * Api services for the `Foto` model.
 */
@Injectable()
export class FotoApi extends BaseLoopBackApi {
  ...
  public getFile(container: any, file: any, customHeaders?: Function): Observable<any> {
    let _method: string = "GET";
    let _url: string = LoopBackConfig.getPath() + "/" + LoopBackConfig.getApiVersion() +
    "/Fotografite/:container/files/:file";
    let _routeParams: any = {
      container: container,
      file: file
    };
  ...
  public download(container: any, file: any, req: any = {}, res: any = {}, customHeaders?: Function): Observable<any> {
    let _method: string = "GET";
    let _url: string = LoopBackConfig.getPath() + "/" + LoopBackConfig.getApiVersion() +
    "/Fotografite/:container/download/:file";
    let _routeParams: any = {
      container: container,
      file: file
    };
